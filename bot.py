...
#قناة المطور @Y_OO_2
ob_start();
$API_KEY = 'توكنك'; 6331053790:AAErWm0d49ztLtKsF5c5tybx0WCMI53r0oQ
...
'inline_keyboard'=>[
[['text'=>'قسم الاشتراك الاجباري ⁦⚜️⁩','callback_data'=>"Arabawi"]],
[['text'=>'قسم توجيه الرسال من الاعضاء 🔙' ,'callback_data'=>"yfffgh"]],
[['text'=>'قسم الاذاعه 🎉' ,'callback_data'=>"6g77g"],['text'=>'احصائيات البوت 👤' ,'callback_data'=>"arabawi"]],
] 
])
]);
}
...
'text'=>'- حسناً ، الآن قم بإرسال معرف قناتك من ثم  قم برفع البوت ادمن في القناة ',
 'reply_markup'=>json_encode([ 
'inline_keyboard'=>[
[['text'=>'🔙' ,'callback_data'=>"arabawi"]],
]])
]);
file_put_contents("AMR.txt","arabawi");
}
if($Tayson and  == "arabawi" and $arabawi == $admin){
bot("sendmessage",[
"chat_id"=>$arabawi,
...
file_put_contents("AMR0.txt","$arabawi");
unlink("AMR.txt");
}
if($AMRD == "delete11"){
bot('EditMessageText',[
...
'inline_keyboard'=>[
[
['text'=>'• لا ، ❎', 'callback_data'=>'arabawi'],
['text'=>'• نعم ، ✅','callback_data'=>'arabawi'],
]
]])
]);
}
...
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(['inline_keyboard'=>[
 [['text'=>'تخمين معرفات ⁦🛎️⁩','callback_data'=>'amr90']], [['text'=>'شرح البوت 💬','callback_data'=>'amr20']],[['text'=>'قناة البوت ⁦↗️⁩','url'=>'https://t.me/$amr2'],['text'=>'المطور ⁦↗️⁩','url'=>'https://t.me/$amr1']],
  ],
  ])
  ]);
  }
...
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(['inline_keyboard'=>[
[[ 'text'=>"تخمين مره اخره ➕", 'callback_data'=>"amr90"]],
[[ 'text'=>"تخمين حروف اكثر ➕", 'callback_data'=>"amr91"]],
...
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(['inline_keyboard'=>[
[[ 'text'=>"تخمين مره اخره ➕", 'callback_data'=>"amr91"]],
[[ 'text'=>"تخمين حروف اكثر ➕", 'callback_data'=>"amr90"]],
[['text'=>"القائمة الرئيسية 🔙",'callback_data'=>"backkk"]],
]])
]);
}
if($data ==  'amr20' ){
  bot( 'editMessageText' ,[
     ...
     'message_id'=>$message_id,
      'text'=>"
*---------------------------------------------
1- يقوم البوت بتخمين معرفات عشوائي 
2- يخمن  معرفات شغاله و معرفات لا 
3- قوم بتخمين معرفات من ثمه فحصه و مبروك
     ---------------------------------------------*
[تم انتهاء الشرح 📮](https://https://t.me/Y_OO_2)
",
          'parse_mode'=>"markdown",
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(['inline_keyboard'=>[
